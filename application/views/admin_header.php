...
<head>
 ...
 <!-- MetisMenu CSS -->
    ...
    <!-- DataTables CSS -->
    <link href="<?php echo base_url_custom;?>admin_assets/vendor/datatables-plugins/dataTables.bootstrap.css" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="<?php echo base_url_custom;?>admin_assets/vendor/datatables-responsive/dataTables.responsive.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?php echo base_url_custom;?>admin_assets/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <!-- <link href="<?php echo base_url_custom;?>admin_assets/vendor/morrisjs/morris.css" rel="stylesheet"> -->
