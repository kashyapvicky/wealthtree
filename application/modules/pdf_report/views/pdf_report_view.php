	...
	<section class="detailed-reportForm-wraper">
		<div class="container" style="padding: 0 20px;">
			...
			<div class="detailed-reportInfo">
				<p style="margin:9px 0;"><b>Organisation- <b><?php echo $user_info_row['organisation']?> (<?php echo $user_info_row['sector']?>) </p>
			...
			<div class="detailed-reportInfo">
				<ul>
					<li>Total family annual income according to this scheme-      <?php echo $this->session->flashdata('total_family_income');?>/-</li>
					<?php if(!empty($user_info_row['pakka_house']))
					{?>
						<li>You own a pucca house <?php echo $user_info_row['pakka_house'];
					...
					<?php } else {?>
					<li>You do not own pucca house.</li>
					<?php }?>
				</ul>
