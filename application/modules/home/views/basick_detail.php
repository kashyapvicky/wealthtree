...
<section class="basicdetail-wraper">
	...
	<div class="container">
		<div class="basic-formWraper">
				...
				<form method="post" action="<?php echo base_url()?>home/insert_basick_detail">
					...
					<div class="col-md-6 col-sm-6">
						<div class="pan-form-row basic-panform-row">
							...
							<input type="text" onblur="is_exist();" name="pan_number" id="pan_number" class="formfull-row" placeholder="Enter Your Pan Number" autocomplete="off" required>
						</div>
					</div>					
					<div class="col-md-6 col-sm-6">
						<div class="first-namebx">
							<label>First Name<sup>*</sup></label>
							<input type="text" name="first_name" id="first_name" class="formfull-row" placeholder="Enter Your First Name" autocomplete="off" required>
						</div>
					</div>
					<div class="col-md-6 col-sm-6">
						<div class="first-namebx email-bx">
							<label>Middle Name</label>
							<input type="text" name="middle_name" id="middle_name" class="formfull-row" placeholder="Enter Your Middle Name" autocomplete="off" >
						</div>
					</div>
					<div class="col-md-6 col-sm-6">
						<div class="first-namebx last-namebx">
							<label>Last Name<sup>*</sup></label>
							<input type="text" name="last_name" id="last_name" class="formfull-row" placeholder="Enter Your Last Name" autocomplete="off" required>
						</div>
					</div>
					<div class="col-md-6 col-sm-6">
					...
					<div class="col-md-6 col-sm-6">
						<div class="first-namebx email-bx">
							<label>Email</label>
							<input type="email" name="email" id="email" class="formfull-row" placeholder="Enter Your Email" autocomplete="off" >
						</div>
					</div>
					<div class="col-md-12 col-sm-12">
 					...
 					<div class="col-md-12 col-sm-12">
						<div class="salary-box">
							<label>Income / Salary (Monthly)<sup></sup></label>
							<input type="number" name="income" id="income" class="formfull-row" placeholder="Enter Your Income / Salary" required autocomplete="off">
						</div>
					</div>
					...
					<div class="col-md-6 col-sm-6">
							<div class="slect-row">
								<select name="org" id="org" class="formfull-row">
									<option disabled selected value="">Organisations<sup></sup></option>
									<?php
					...
					<div class="col-md-6 col-sm-6">
						<div class="slect-row">
							<select name="psu" id="psu"  class="formfull-row">
								<option disabled selected value="">Public Sector Undertakings (PSU)<sup></sup></option>
								<?php
								if(!empty($sectors))
								{
			...
			<p style="width: 100%; float: left; clear: both; font-size: 19px; position: relative; left: 0%; padding: 0 0px 0 24px;"><span style="color: red; font-size: 60px; position: absolute; top: -17px; left: 0;">*</span> fields are compulsory</p>
		</div>
	</div>
</section>
