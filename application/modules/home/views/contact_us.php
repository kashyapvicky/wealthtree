	<section class="contactus-wraper">
		<div class="container">
			<div class="contactus-infobx">
				...
				<p>Ask us your query regarding survey, PMAY scheme and our services</p>
			...
			<div class="conatct-formbx">
				<div class="contactForm">
					...
					<form method="post" name="form1" action="<?php base_url()?>home/insert_query" id="myForm">
						<div class="form-row">
							<input type="text" name="name" placeholder="Your Name*" autocomplete="off" data-msg-required="Please tell us your name." value="<?php if(!empty($user_info)){echo $user_info['first_name'];}?>" required="">
						</div>
						<div class="form-row">
							<input type="email" value="<?php if(!empty($user_info)){echo $user_info['email'];}?>" name="email" placeholder="Email" autocomplete="off" >
						</div>
						<div class="form-row">
							<input type="text" name="phone" value="<?php if(!empty($user_info)){echo $user_info['phone_number'];}?>" placeholder="Phone Number*" autocomplete="off" required="" required="">
						</div>
						<div class="form-row">
