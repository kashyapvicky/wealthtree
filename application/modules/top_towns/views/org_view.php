        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">Organisations</h1>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             <button data-toggle="modal" data-target="#myModal" class="btn btn-primary">Add Organisation</button>  
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        foreach ($org as $key => $value)
                                        {
                                            ...
                                            <button class='tab_btn_classs btn btn-info' data='".$value['id']."' value='".$value['name']."' data-toggle='modal' data-target='#editModal' class='btn btn-primary'>Edit</button>
                                            <a href='".base_url('org/delete_org?id='.$value['id'].'')."' class='btn btn-danger' onClick='return doconfirm();'>Delete</a>
                                            </td>";
