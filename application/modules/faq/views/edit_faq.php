                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form id="" action="<?php echo base_url('faq/edit_faq')?>" method="post">
                                <input type="hidden" name="qs_id" value="<?php echo $details['fq_id']; ?>">
                                <div class="row">
                                    <div class="col-md-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        if(!empty($details))
                                        {
                                            ...
                                            $question_hin=$details['question_hin'];
                                            $answer_hin = $details['answer_hin'];
                                        }
                                        else
                                        {
                                            $question='';
                                        ...
                                        ?>
                                       <textarea required  name="question" placeholder="Type your question here.." class="form-control"><?php echo $question;?></textarea> 
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       /* if(!empty($details))
                                        ...
                                        ?>
                                       <textarea required  name="question_hin" placeholder="Type your question here.." class="form-control"><?php echo $question_hin;?></textarea> 
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea  class="form-control" required   name="answer" placeholder="Type your answer here.."><?php echo $answer;?></textarea>
                                    </div>
                                </div>
                               ...
                               <br>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea  class="form-control" required   name="answer_hin" placeholder="Type your answer here.."><?php echo $answer_hin;?></textarea>
                                    </div>
                                </div>
                               <br>
                                 <div class="row">
