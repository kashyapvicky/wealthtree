<?php
  Class Faq_model extends CI_Model
  {
    ...
    {
      $this->db->where($where);
      $this->db->select('ft.name as tab,fq.name as question,fq.name_hin as question_hin,fa.name_hin as answer_hin,fq.id as qs_id,fa.name as answer');
    ...
    {
      $this->db->select('ft.id as tab_id,fq.name as question,fa.name_hin as answer_hin ,fq.name_hin as question_hin,fq.id as fq_id,fa.name as answer,fa.id as fa_id');
