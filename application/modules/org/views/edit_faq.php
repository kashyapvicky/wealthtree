                            ...
                            <form id="" action="<?php echo base_url('faq/edit_faq')?>" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        ?>
                                       <textarea required  name="question" placeholder="Type your question here.." class="form-control"><?php echo $value;?></textarea> 
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea  class="form-control" required   name="answer" placeholder="Type your answer here.."><?php echo $ans;?></textarea>
                                    </div>
                                </div>
                                </div>
                                 <div class="row">
