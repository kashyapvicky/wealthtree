...
class Survey extends MX_Controller {
	...
	public function get_nearest_city()
	{
		...
		$output='';
		$output="<option disabled selected value=''>Nearby Places</option>";
	...
	public function get_moza()
	{
		...
		$output='';
		$output="<option disabled selected value=''>Moza</option>";
		...
		$output.="<option value='moza_others'>Others(Fill your own Town)</option>";
		//print_r($output);
		$data=array(
			'option'=>$output,
			//'sname'=>$state_name
