	...
	<div class="container">
		<div class="wealth-tab">
			<form method="post" id="survey_form" action=<?php echo base_url()?>survey/survey_data>
				<ul class="tab-list">
					<li><a href="javascript:void(0)" class="tab tab-ac1 active">अपनी पात्रता जानें</a></li>
					<li><a href="javascript:void(0)" class="tab tab-ac2">प्रिफरेंस </a></li>
				</ul>
				<div class="tab-content show" id="tab1">
					<div class="wealth-que-tab" id="que1">
						<h1 class="border-center-hding">आप अपने घर का निर्माण कहाँ करना चाहते हैं?</h1>
						<div class="row">
							<div class="col-md-4 col-sm-4">
								<div class="slect-row">
									<select  id="state_id" name="state_id" onchange="get_city(this.value)" class="formfull-row" id="state">
										<option value="0" selected>अपने राज्य का चयन करें</option>
										<?php
										//print_r($states); die;
										if(!empty($states))
										{
							...
							<div class="col-md-4 col-sm-4">
								<div class="slect-row">
									<select name="district_id" class="formfull-row" id="city" onchange="get_town(this.value)">
										<option value="0" selected="">अपने ज़िले का चयन करें</option>
									</select>
								</div>
							</div>
							<div class="col-md-4 col-sm-4">
								<div class="slect-row">
									<input type="text" id="town_field" autocomplete="off" value=""  onkeyup="get_town_name(this.value)" placeholder="अपने शहर / गांव के दो अक्षर लिखें" name="town_search" class="formfull-row1">
						...
						<a href="javascript:void(0)" id="next" class="next-btn">अगला</a>
					</div><!-- tab que end -->

					<div class="wealth-que-tab" id="que2">
						<h1 class="border-center-hding">क्या आप एक पक्के घर के मालिक हैं?</h1>
						<div class="pkka-houseResultbx">
							<div class="row">
								<div class="col-md-5 col-sm-5 col-xs-6 bd-radio">
									...
									<label for="test9">हाँ</label>
								</div>
								<div class="col-md-5 col-sm-5 col-xs-6 bd-radio">
									<input  type="radio" id="testa9" name="is_pakka" value="no">
									<label for="testa9">नहीं</label>
								</div>
							</div>
						</div>
						<div class="pakka-house-memberbx" id="pkhouse">
							<div class="bd-radio pk-memberbx">
								...
								<label for="test10">मेरे नाम पर </label>
							</div>
							<div class="bd-radio pk-memberbx">
								<input type="radio" id="test11" name="pakka" value="in name of your wife">
								<label for="test11">मेरी पत्नी के नाम पर</label>
							</div>
							<div class="bd-radio pk-memberbx">
								<input type="radio" id="test12" name="pakka" value="in joint name of your  husband/wife and you">
								<label for="test12">मेरी पत्नी और मेरे  संयुक्त नाम पर </label>
							</div>
							<div class="bd-radio pk-memberbx" title="Age 18 or less than 18" >
								<input type="radio" id="test13" name="pakka" value="in name of any of your minor dependent Children">
								<label for="test13">मेरे छोटे बच्चों में से किसी के नाम पर</label>
							</div>
						</div>
						<a href="javascript:void(0)" id="back-btn1" class="next-btn back-btn">पिछला</a>
						<a href="javascript:void(0)" id="next1" class="next-btn">अगला</a>
					</div><!-- tab que end -->

					<div class="wealth-que-tab" id="que3">
						<h1 class="border-center-hding">आपके परिवार में किसकी स्वतंत्र आय है</h1>
						<div class="faimily-incomebox">
							<label class="container-check">किसीकी नहीं
								<input type="checkbox" class="ncheck" name="family" id="nooneCheckbx" value="noone" checked>
								<span class="checkmark"></span>
							</label>
							<label class="container-check">पति / पत्नी
								<input type="checkbox" class="wcheck check-noone" name="family" value="yes">
								<span class="checkmark"></span>
							</label>
							<div class="wife-salary-row" >
								<input type="number" name="independent_wife" placeholder="अपनी आय / वेतन (मासिक) दर्ज करें" class="wsalary">
							</div>

							<label class="container-check">बेटा
								...
								<div class="row">
									<div class="col-md-4 col-sm-4 col-xs-12 sagebx">
										<select name="son[age][]" class="sage sonAge">
											<option value ="0" style="background-color:#D3D3D3;"  selected>आयु का चयन करें</option>
											<option value="17">18 से कम है</option>
											<option value="18">18 और ऊपर</option>
										</select>
									</div>
									<div class="col-md-8 col-sm-8 col-xs-12">
										<input type="number" id="append_son" name="son[salary][]" placeholder="अपनी आय / वेतन (मासिक) दर्ज करें" class="wsalary sonSal">
									</div>
								</div>
							</div>
							...
							<label class="container-check check-noone">बेटी
							...
							<div class="daughter-salary-row">
								<div class="row">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										<input type="number" id="append_dau" name="daughter[salary][]" placeholder="अपनी आय / वेतन (मासिक) दर्ज करें" class="wsalary dsalary">
									</div>
								</div>
							</div>
							<span id="daughtersalaryrow"></span>
						</div>
						<a href="javascript:void(0)" id="next3" class="next-btn">अगला</a>
						<a href="javascript:void(0)" id="back-btn" class="next-btn back-btn">पिछला</a>
					</div>
					<div class="wealth-que-tab" id="ques4">
						<h1 class="border-center-hding">आप  क्या चाहते हो?</h1>
						<div class="pkka-houseResultbx">
							<div class="row">
								<div class="col-md-4 col-sm-4 col-xs-6 bd-radio">
									<input type="radio" id="construct" name="what_want" value="1">
									<label for="construct"> घर  का निर्माण</label>
								</div>
								<div class="col-md-4 col-sm-4 col-xs-6 bd-radio">
									<input  type="radio" id="purchase" name="what_want" value="2">
									<label for="purchase">खरीद फरोख्त</label>
								</div>
								<div class="col-md-4 col-sm-4 col-xs-6 bd-radio">
									<input  type="radio" id="add_rooms" name="what_want" value="3">
									<label for="add_rooms">मौजूदा घर में कमरे बनबायें</label>
								</div>
							</div>
						</div>
						...
						<a href="javascript:void(0)" id="back-btn2" class="next-btn back-btn">पिछला</a>
					</div>
	...
	<div class="optionPopup-inner">
		<form method="post" action="survey/town_data">
			<div class="first-namebx town-namebx">
				<label>अपने शहर का नाम दर्ज करें</label>
				<input type="text" id="town" name="first_name" class="formfull-row" placeholder="अपने शहर का नाम दर्ज करें" autocomplete="off" required>
			</div>
			<input type="button" onclick="submit_town_data()" name="send" class="form-btn" value="सबमिट करे">
		</form>
	</div>
		...
		<form method="post" action="survey/town_data">
			...
			<div class=" town-namebx slect-row">
				<select onchange="get_moza(this.value)" id="near_id" class="formfull-row">
					<option disabled selected>निकटतम शहर</option>
					<option>मोजा</option>
				</select>
			</div>
			<div class=" town-namebx slect-row">
				<select id="moza_select" onchange="other_moza(this.value)" class="formfull-row">
					<option disabled selected>मोजा</option>
				</select>
			</div>
			<input type="button" onclick="assian_hidden_val_move_next()" name="send" class="form-btn" value="सबमिट करे">
		</form>
	</div>
...
<div class="mozapopup">
	<div class="mozapopup-inner">
		<form method="post" action="">
			<div class="first-namebx town-namebx">
				<label>अपना मोजा नाम दर्ज करें</label>
				<input type="text" id="moza_input" name="moza_name" class="formfull-row" placeholder="अपना मोजा नाम दर्ज करें" autocomplete="off" required>
			</div>
			<input type="button" onclick="submit_moza_data()" name="send" class="form-btn" value="सबमिट करे">
		</form>
	</div>
