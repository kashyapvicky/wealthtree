		...
		<div class="container">
			<div class="withPmay-schemebx">
				...
				<div class="withPmay-inputWraper">
					<div class="withPmay-inputbx">
						...
						<input type="text" name="" id="subsidy_pmay">
					</div>
					<div class="withPmay-inputbx">
						<label>EMI</label>
						<input type="text" name="" id="emi">
					</div>
						<p>Total Amount you will be paying</p>
					<div class="withPmay-inputbx">
						<label>In <span id="tenure_year"></span> Years</label>
						<input type="text" name="" id="pmay_in_t_year">
					</div>
				</div>
			...
			<div class="withoutPmay-schemebx">
				...
				<div class="withoutPmay-inputWraper">
					<div class="withoutPmay-inputbx withPmay-inputbx">
						<label>Total Subsidy Given</label>
						<input type="text" name="" id="subsidy_without_pmay">
					</div>
					<div class="withoutPmay-inputbx withPmay-inputbx">
						<label>EMI</label>
						<input type="text" name="" id ="without_pmay_id">
					</div>
						<p>Total Amount you will be paying</p>
					<div class="withoutPmay-inputbx withPmay-inputbx">
						<label>In <span id="tenure_year_without_pmay"></span> Year</label>
						<input type="text" name="" id="without_pmay_in_t_year">
					</div>
				</div>
			</div>
			<div class="totalsavingPercenteg-bx">
				<div class="totalSavingbx">
					...
					<input type="text" name="" id="total_saving">
				</div>
