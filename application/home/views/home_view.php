		...
		<div class="row">
			...
			<div class="col-md-8 col-sm-7">
				...
				<div class="get-service-box">
					<h2>Get Services</h2>
					<p>Consultation/Legal Matters/Architchural Engineering/Finance/Others Services</p>
		...
		<div class="work-category-wraper">
			<div class="work-category-item1">
				...
				<div class="work-category-item-image">
					<img src="images/subsidy1.png" alt="" class="img-responsive">
				</div>
			</div>
			<div class="work-category-item2">
				<div class="work-category-item-image">
					<img src="images/requirement.png" alt="" class="img-responsive">
				</div>
				<div class="work-category-item-info">
			...
			<div class="work-category-item3">
				...
				<div class="work-category-item-image">
					<img src="images/customized.png" alt="" class="img-responsive">
				</div>
			</div>
			<div class="work-category-item4">
				<div class="work-category-item-image">
					<img src="images/loan-subsidy.png" alt="" class="img-responsive">
				</div>
				<div class="work-category-item-info">
