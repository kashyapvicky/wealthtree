...
abstract class REST_Controller extends CI_Controller
{
    ...
    */
    ...
    public function responseNew($data = null, $http_code = null)
    {
//echo '<pre>';print_r($data);exit;
            return json_encode($data);
    }
    public function errorCode($codeKey = null)
    {
        ...
        return $arrErrorCode[$codeKey];
    }
    public function successCode($codeKey = null)
    {
        $arrSuccessCode = array(
            '0'=>'Data Fetch',
            '1'=>'Data Send'
        );

        return $arrSuccessCode[$codeKey];
    }
